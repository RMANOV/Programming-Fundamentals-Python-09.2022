...
days1 = 20
days2 = 10
bisquits_per_month = (bisquits_per_day * days1) + (bisquits_per_day * days2 * 0.75)
...
if my_factory_vs_competitor > 1:
    print(f"You produce {my_factory_vs_competitor_rounded:.2f} percent more biscuits.")
else:
    print(f"You produce {abs(my_factory_vs_competitor_rounded):.2f} percent less biscuits.")
