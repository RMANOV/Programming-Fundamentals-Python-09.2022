...
searched_pattern = r"([a-z]{3,})|(\d{1,})"
result = re.findall(searched_pattern, initial_string)
for i in range(0, len(result), 2):
    color = result[i][0]
    if color != "red" and color != "green" and color != "blue" and color != "yellow" and color != "purple" and color != "orange" and color != "lime" and color != "black":
        continue
    amount = result[i + 1][1]
...
#         and color != "orange"
#     ):
#         # delete the color from the dictionary
#         colors_and_amounts.pop(color, None)
