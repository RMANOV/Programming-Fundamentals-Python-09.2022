    ...
    if command.startswith("exchange"):
        ...
        if command.endswith("even"):
            ...
            if len(even_list) == 0:
                ...
                print(initial_list.index(str(max(even_list))))
        elif command.endswith("odd"):
            for i in initial_list:
                if int(i) % 2 != 0:
            ...
            if len(odd_list) == 0:
                ...
                print(initial_list.index(str(max(odd_list))))
        ...
        if command.endswith("even"):
            ...
            if len(even_list) == 0:
                ...
                print(initial_list.index(str(min(even_list))))
        elif command.endswith("odd"):
            for i in initial_list:
                if int(i) % 2 != 0:
                    odd_list.append(int(i))
            if len(odd_list) == 0:
                ...
                print(initial_list.index(str(min(odd_list))))
    elif command.startswith("first"):
        count = int(command.split()[1])
        if count > len(initial_list):
            print("Invalid count")
        elif command.endswith("even"):
            for i in initial_list:
                if int(i) % 2 == 0:
                    even_list.append(int(i))
            if len(even_list) == 0:
...
#         else:
#             odd_list = [x for x in initial_list if x % 2 == 1]
#             if len(odd_list) == 0:
#                 print("No matches")
#             else:
